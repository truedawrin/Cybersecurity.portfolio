...
A Bash utility for rapidly creating multiple files and directories through a simple interactive prompt flow.

## Objective

Practice Bash scripting by turning repetitive filesystem operations into a small reusable command-line tool.
...
## Why it belongs in a cybersecurity portfolio

This is not a security exploit tool. It demonstrates a foundational capability that matters in security engineering: automating repetitive terminal work safely and predictably.

## More
a Bash-based utility designed to make creating multiple files and directories faster and easier.
...
- Validation and safer path handling
- Logging
